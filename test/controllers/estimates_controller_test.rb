...
class EstimatesControllerTest < ActionController::TestCase
  ...
  test "should create estimate" do
    assert_difference('Estimate.count') do
      post :create, estimate: { e_type: @estimate.e_type, recall_id: @estimate.recall_id, user_id: @estimate.user_id }
    end
  ...
  test "should update estimate" do
    patch :update, id: @estimate, estimate: { e_type: @estimate.e_type, recall_id: @estimate.recall_id, user_id: @estimate.user_id }
    assert_redirected_to estimate_path(assigns(:estimate))
  end
