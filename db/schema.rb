...
ActiveRecord::Schema.define(version: 20160406160624) do
  ...
  add_index "comments", ["recall_id"], name: "index_comments_on_recall_id"
  ...
  add_index "estimates", ["recall_id"], name: "index_estimates_on_recall_id"
  ...
  add_index "recalls", ["film_id"], name: "index_recalls_on_film_id"
  add_index "recalls", ["user_id"], name: "index_recalls_on_user_id"
